# Data Day Champions — RIDG Announcement Remarks

*Spoken remarks, roughly 3 to 4 minutes at a conversational pace (~450 words). Delivered by Jordan Inskeep ahead of the broad recruitment email.*
...
Two. Share the Call for Proposals, late September into October. Forward it, and nudge the person you know who should be presenting.

Three. Introduce us to potential sponsors, in the fall. Introductions only.
...
One thing that makes this work: Champions connect, amplify, and host. MORPC owns the decisions, the money, and the commitments. You're never on the hook for a deadline or a contract or a conversation about sponsorship levels. We're asking you to open doors, not to carry the load.

You also won't get an ask without the materials to go with it. When we ask you to share the Call for Proposals, you'll have the copy, the graphic, and the dates in hand.

The email comes in the next day or two. It has a short sign-up form, a one-page description of the five ways to help, and an FAQ. If you already have a keynote in mind, there's a separate form for that, and you don't need to sign up to use it.
