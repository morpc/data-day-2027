# Data Day 2027 Champions — Program Launch Checklist

## Purpose

This checklist is for the staff launching and running the Data Day Champions program — the new volunteer model replacing the Working Group. Work the phases roughly in order; each builds the conditions for the next.
...
Decisions to make before any materials go out.
...
- [x] **Lock the open policy decisions:**
  ...
  - [x] Brand-use guidance for Champions posting under the MORPC / Data Day name. → FAQ "Ground rules" section.
  - [x] Guidance on supervisor sign-off for public-employee Champions doing this on work time. → FAQ "Ground rules" section.
- [x] **Define success metrics up front** (see Metrics section below).

---

## Phase 2 — Build the infrastructure *(suggested: July–August 2026)*
...
## Phase 4 — Run the asks *(September 2026 – February 2027)*

For each ask: confirm the kit is ready, make the right ask to the right Champion at the right time, and confirm a **staff fallback owner** so the critical path is never dependent on a volunteer.

- [ ] **Keynote connections** *(Aug–Oct; finalize mid-Nov)* — Champions suggest/intro candidates. **Staff fallback owner: ______.**
...
## Phase 5 — Recognize, evaluate, re-recruit *(February–March 2027)*

- [ ] **Recognize Champions** per the Phase 1 decision (program, website, event).
- [ ] **Close the loop with each Champion** on the impact of their contribution.
- [ ] **Run a short Champion survey** — what worked, what was unclear, would they return.
- [ ] **Internal debrief** — review metrics and capture lessons for next year.
- [ ] **Flag returning Champions** for an easy re-recruit in the 2028 cycle.

---

## Metrics to track

- [ ] Keynote leads sourced from Champions (and how many converted)
- [ ] Sponsor leads/introductions from Champions (and dollars closed)
- [ ] CFP submissions attributable to Champion promotion
- [ ] Registrations attributable to Champion outreach
- [ ] Sessions facilitated / day-of roles filled by Champions
- [ ] Champion retention (share who say they'd return)

---

## Critical-path coverage rule

Before each milestone deadline, check the tracking sheet: **does every critical-path ask have both a Champion and a named staff fallback?** Any high-stakes item showing Champion-only coverage with no fallback is a risk — assign staff backup immediately.